...
_EXTRACTEDENTITY_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='IPADDRESS', index=4, number=4,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
