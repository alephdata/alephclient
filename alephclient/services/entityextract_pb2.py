...
_EXTRACTEDENTITY_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='IPADDRESS', index=5, number=5,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PHONE', index=6, number=6,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
