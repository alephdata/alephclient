...
class EntityExtractStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Extract = channel.unary_stream(
        ...
        request_serializer=alephclient_dot_services_dot_entityextract__pb2.Text.SerializeToString,
...
def add_EntityExtractServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'Extract': grpc.unary_stream_rpc_method_handler(
          servicer.Extract,
          request_deserializer=alephclient_dot_services_dot_entityextract__pb2.Text.FromString,
